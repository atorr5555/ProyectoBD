...
) as select v.vehiculo_id,v.anio,v.numero_serie,pp.nombre,p.num_placa
...
) as select c.vehiculo_id,c.capacidad_toneladas,v.anio, m.nombre
...
) as select t.vehiculo_id, t.num_pasajeros_sentados,v.anio
