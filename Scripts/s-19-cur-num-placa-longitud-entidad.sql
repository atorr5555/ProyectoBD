...
select e.clave,e.nombre,p.num_placa,p.fecha_asignacion,length(p.num_placa) tamano
from entidad e,placa p
where p.entidad_id=e.entidad_id and e.clave='AGS' and p.fecha_asignacion is not null
