...
Prompt creando sinonimos para invitado:

create or replace public synonym vehiculo for fftv_proy_invitado;
create or replace public synonym propietario for fftv_proy_invitado;
create or replace public synonym placa for fftv_proy_invitado;
create or replace public synonym licencia for fftv_proy_invitado;
create or replace public synonym historico_propietario for fftv_proy_invitado;
create or replace public synonym historico_status for fftv_proy_invitado;
